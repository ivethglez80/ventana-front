...
type TraduccionesDetalleProps = {
    id: number;
  };

export default function Traducciones_detalle ({ id }: TraduccionesDetalleProps) {
    const handleSave = () => {
        ...
        <div className="bg-grayD h-full w-full md:w-[1100px] rounded-xl text-grayL px-6 pb-6">
                <div className="flex flex-row justify-between border-b border-grayL pt-4 pb-2 items-center">
                  <span className="flex flex-row gap-2">
                    ...
                    <p className="text-lg">
                      <b>Traducción /</b> <span className="text-base">Editar trad id: {id}</span>
                    </p>
                  </span>
                </div>
